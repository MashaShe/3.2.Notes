...
//        assertEquals(result, expected)
    ...
    fun getNotesTest() {
        ...
        val result = NotesService.get(IntArray(2,{1;2}),3).size
        val expected = 2
        assertEquals(result,expected)
